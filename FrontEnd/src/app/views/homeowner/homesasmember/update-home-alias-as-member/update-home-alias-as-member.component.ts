...
@Component({
  selector: 'app-update-home-alias-as-member',
  templateUrl: './update-home-alias-as-member.component.html',
  styleUrls: ['./update-home-alias-as-member.component.css'],
})
export class UpdateHomeAliasAsMemberComponent implements OnInit {
  form!: FormGroup;
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<UpdateHomeAliasAsMemberComponent>,
