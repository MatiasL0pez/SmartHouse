...
@Component({
  selector: 'app-add-homedevice-room',
  templateUrl: './add-homedevice-room.component.html',
  styleUrls: ['./add-homedevice-room.component.css'],
})
export class AddHomedeviceRoomComponent {
  form!: FormGroup;
  roomId: number;
  homeId: number;
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<AddHomedeviceRoomComponent>,
